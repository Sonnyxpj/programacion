...
def tragamonedas(saldo, separador): #Mantiene en ejecución el juego
    detener = False
    ...
    while detener != True: 
        ...
        detener = cond_para_detener(saldo)#Detendrá el programa si cumple las condiciones
    ...
    while suficiente != True:
        ...
        if comprobar == True:
            if int(saldo_inicial) < 100:
                ...
                suficiente == True
                return int(saldo_inicial) #Solo aceptará saldo mayor o igual a $100
...
def apostar(saldo): 
    ...
    while apostando == True: 
        ...
        if comprobar == True:
            ...
            if apostar == 100 or apostar == 500 or apostar == 1000:#Verifica que se apuesten los valores correctos
                if saldo < apostar:
...
def verifica_dinero(dinero): #Solo aceptará valores numéricos positivos
...
def cond_para_detener(saldo):
    print()
    if saldo < 100: #Para jugar se debe tener mínimo $100
        print("Tu saldo actual: $" + str(saldo))
        ...
        while decidido != True: #El jugador tomará la decisión
            print("Tu saldo actual: $" + str(saldo))
